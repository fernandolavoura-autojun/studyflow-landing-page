...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-cYsJqf3O.js");
...
var ROUTER_BASEPATH = "studyflow-landing-page";
var SERVER_FN_BASE = "/studyflow-landing-page/_serverFn/";
